...
<section class="d-flex justify-content-center align-items-center flex-column col-12 col-md-12 mb-1 mt-2">
    <div class="col-10">
        ...
        <h1 class=" text-center mb-4">Registros de machos de inventario</h1>
        <div class="d-flex flex-row mb-1 mb-0">
            ...
            <div class="d-flex flex-row justify-content-around align-items-center col-11 col-xl-3">
                <a href="macho.php"><button class="form-control btn btn-warning" style="" ><i class="bi bi-arrow-left"></i>Regresar </button></a>
...
<section class="mb-5 mt-4" style=" padding-right: 3%; padding-left: 3%;">
    <div style=" border: 1px solid #000; overflow-x:auto;">
        ...
        try {
            ...
            //$sql = "SELECT id_toro, padre_num, padre_raza, madre_num, madere_raza FROM macho WHERE rol = 'agente'";
            ...
            celo,
             foto, observaciones, fecha_registro FROM macho ";
            ...
            echo '<table class="table table-bordered table-striped border border-2 " >
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Número de toro</th>
                        <th scope="col">Número de arete</th>
                        <th scope="col">Raza de la toro</th>
            ...
            while ($arreglo_sql = $stmt->fetch(PDO::FETCH_ASSOC)) {
                echo '<tr>';
                   // echo '<td> <a href="macho-tabla.php"><button class="form-control btn-danger"><i style="margin-right:5px;" class="bi bi-trash"></i>Eliminar</button></a></td>';
                    echo '<td> 
                            <form action="eliminar-macho.php" method="POST">
                                <input type="hidden" name="id_toro"  value="'. $arreglo_sql['id_toro'].'" >
                   ...
                   // echo '<td> <a href="editar-macho.php"><button class="form-control btn-info"><i style="margin-right:5px;" class="bi bi-pencil-square"></i>Editar</button></a></td>';
                    echo '<td> 
                    ...
                    echo '<td>' . $arreglo_sql['id_toro'] . '</td>';
                    ...
                    echo '<td>' . $arreglo_sql['toro_num'] . '</td>';
                    echo '<td>' . $arreglo_sql['toro_arete'] . '</td>';
                    echo '<td>' . $arreglo_sql['toro_raza'] . '</td>';
