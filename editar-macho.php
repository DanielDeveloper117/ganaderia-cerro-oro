...
if (isset($_POST['id_toro'])) {
    ...
    try {
        $sql = "SELECT id_toro, padre_num, padre_raza, madre_num, madre_raza,
        ...
        toro_num, toro_arete, toro_raza, fecha_aretado, estatus, 
        potrero, lote, estado_reproductivo,
        celo, 
         foto, observaciones, fecha_registro FROM macho WHERE id_toro = :id_toro";
        ...
        <a href="macho-tabla.php" class="btn btn-warning" >Regresar</a></div>';
    }
} else {
...
<head>
    <meta charset="UTF-8">
    <meta value="<?php echo '' . $arreglo_sql['id_toro'] . '';?>" name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <div class="col-10">
        ...
        <div class="d-flex flex-row mb-2">
            ...
            <div class="d-flex flex-row justify-content-around align-items-center col-9 col-xl-3">
                <a href="macho-tabla.php"><button class="form-control btn btn-warning" style="" ><i class="bi bi-arrow-left"></i>Cancelar y regresar</button></a>
...
<section class="d-flex col-12 flex-column align-items-center justify-content-center" >    
    <form class=" d-flex flex-column col-11 col-md-10 justify-content-center align-items-center"  action="editar-macho-script.php" method="POST" enctype="multipart/form-data">

        <input type="hidden" value="<?php echo '' . $arreglo_sql['id_toro'] . '';?>" name="id_toro">
        ...
        <div class="justify-content-md-between d-md-flex flex-md-row col-md-12">
            ...
            <div class="col-md-3 " >
                ...
                <input type="number" class="form-control" id="padre_num" placeholder="Número de la toro" value="<?php echo '' . $arreglo_sql['madre_num'] . '';?>" name="madre_num" >
            </div>

            <div class="col-md-2 " >
                <label class="label-form" for="madre_raza">Raza de la madre</label>
                <input type="text" class="form-control" id="madre_raza" placeholder="Raza de la toro" value="<?php echo '' . $arreglo_sql['madre_raza'] . '';?>" name="madre_raza" >
            </div>
        </div>
        ...
        <div class="justify-content-md-between d-md-flex flex-md-row col-md-12">        
            <div class=" col-md-3" >
                <label class="label-form" for="toro_num">Número de la toro</label>
                <input type="number" class="form-control" id="toro_num" placeholder="Número de la toro" value="<?php echo '' . $arreglo_sql['toro_num'] . '';?>" name="toro_num" >
            </div>

            <div class=" col-md-3" >
                <label class="label-form" for="toro_arete">Arete de la toro</label>
                <input type="text" class="form-control" id="toro_arete" placeholder="Número del arete de la toro" value="<?php echo '' . $arreglo_sql['toro_arete'] . '';?>" name="toro_arete" >
            </div>        
        
            <div class=" col-md-2" >
                <label class="label-form" for="toro_raza">Raza de la toro</label>
                <input type="text" class="form-control" id="toro_raza" placeholder="Raza de la toro" value="<?php echo '' . $arreglo_sql['toro_raza'] . '';?>" name="toro_raza" >
            </div>
