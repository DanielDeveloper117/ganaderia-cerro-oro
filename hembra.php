...
<section class="d-flex justify-content-center align-items-center flex-column col-12 col-md-12 mb-3 mt-5">
    <div class="col-10">
        ...
        <h1 class=" text-center mb-4">Registro de hembra</h1>
    ...
    <form class=" d-flex flex-column col-11 col-md-10 justify-content-center align-items-center"  action="hembra-script.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="justify-content-md-between d-md-flex flex-md-row col-md-12">
            ...
            <div class="col-md-3 " >
                ...
                <input type="number" class="form-control" id="padre_num" placeholder="Número de la vaca" name="madre_num" >
            </div>

            <div class="col-md-2 " >
                <label class="label-form" for="madre_raza">Raza de la madre</label>
                <input type="text" class="form-control" id="madre_raza" placeholder="Raza de la vaca" name="madre_raza" >
            </div>
        </div>
        ...
        <div class="justify-content-md-between d-md-flex flex-md-row col-md-12">        
            <div class=" col-md-2" >
                ...
                <input type="number" class="form-control" id="vaca_num" placeholder="Número de la vaca" name="vaca_num" >
            </div>
       ...
       <div class="justify-content-md-between d-md-flex flex-md-row col-md-12"> 
        ...
        <div class="justify-content-md-between d-md-flex flex-md-row col-md-12"> 
            ...
            <div class=" col-md-2" >
                <label class="label-form" for="parto_num">Número de partos</label>
                <input type="number" class="form-control" id="parto_num" placeholder="Número de partos" name="parto_num" >
            </div>

            <div class="col-md-3 " >
                <label class="label-form" for="estado_palpacion">Estado de palpación</label>
                <input type="text" class="form-control" id="estado_palpacion" placeholder="Estado de palpación" name="estado_palpacion" >
            </div>        
        
            <div class="col-md-2 " >
                <label class="label-form" for="fecha_probable">Fecha probable</label>
                <input type="date" class="form-control" id="fecha_probable" placeholder="Fecha probable" name="fecha_probable" >
            </div>
        </div>
